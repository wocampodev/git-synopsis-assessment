...
## Actividad 2:  Generar 2 carpetas cualquiera sin contenido que sean incluidas en el historial de cambios.
...
## Actividad 3: Generar otra rama B para realizar nuevas modificaciones y luego integrar estos en la rama A.

![image](https://github.com/user-attachments/assets/76dc810e-b3d3-485b-8a81-6254137454df)

## Actividad 4: Integrar SOLO el commit con nombre "FIX: issue 2" de la rama hotfix/main en la rama A
...
## Actividad 5: Ejemplifique el uso de git para la modificación de ficheros en la rama A y en la rama B simultaneamente sin generar commits en el historial de cambios.
...
## Actividad 6: Ejemplifique el uso de git para la generación y publicación de un nuevo release (versión) de su código
